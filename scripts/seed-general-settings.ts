...
async function upsertGeneralSettings() {
  try {
    ...
    const doc = {
      ...
      socials: [
        { _key: 'fb', platform: 'facebook', url: 'https://facebook.com/kumo' },
        { _key: 'ig', platform: 'instagram', url: 'https://instagram.com/kumo' },
        { _key: 'tw', platform: 'twitter', url: 'https://x.com/kumo' },
        { _key: 'li', platform: 'linkedin', url: 'https://linkedin.com/company/kumo' },
        { _key: 'yt', platform: 'youtube', url: 'https://youtube.com/@kumo' },
        { _key: 'tt', platform: 'tiktok', url: 'https://tiktok.com/@kumo' },
        { _key: 'wa', platform: 'whatsapp', url: 'https://wa.me/573000000000' },
      ],
